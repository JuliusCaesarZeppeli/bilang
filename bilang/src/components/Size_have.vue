...
<template>
  <div class="bg">
    ...
    <div class="footer">
      <p>体型分析</p>
      <p>健美型身材。肩很宽、很厚、结实、健壮，腰明显较细，大腿部的肌肉很发达。</p>
    </div>
  </div>
</template>
<script>
...
.banner{
  ...
  width: 7.5rem;
  height: 2rem;
  background-image:url("../assets/images/我的尺寸/img_111.png");
